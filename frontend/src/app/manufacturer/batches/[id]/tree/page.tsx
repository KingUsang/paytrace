...
export default function BatchTreePage({ params }: { params: { id: string } }) {
  return (
    <div className="flex-1 p-margin-mobile md:p-margin-desktop w-full max-w-container-max-width mx-auto">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h2 className="font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg text-primary">Batch Detail View</h2>
          <p className="font-body-sm text-body-sm text-on-surface-variant">Custody tracking and allocation history.</p>
        </div>
      </div>

      {/* Header Information Card */}
      <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-6 mb-12 shadow-sm">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <p className="font-label-caps text-label-caps text-on-surface-variant uppercase tracking-wider mb-1">Batch ID</p>
            <p className="font-data-mono text-data-mono text-primary text-lg">{params.id || '#PT-AUG-001'}</p>
          </div>
          <div>
            ...
            <div className="relative flex flex-col items-center">
              <div className="bg-surface-container-lowest border-2 border-primary rounded-lg p-4 w-64 shadow-sm z-10 text-center relative">
                <div className="absolute -top-3 -right-3 bg-secondary text-on-secondary w-8 h-8 rounded-full flex items-center justify-center border-2 border-surface-container-lowest shadow-sm">
                  <span className="material-symbols-outlined text-[16px]" style={{ fontVariationSettings: "'FILL' 0" }}>factory</span>
                </div>
              ...
              {/* Line down from Root */}
              <div className="w-[2px] h-8 bg-outline-variant"></div>
              
              {/* Horizontal Distribution Line */}
              <div className="relative w-[600px] h-8">
                <div className="absolute top-0 left-0 w-full h-[2px] bg-outline-variant"></div>
                {/* Drops to distributors */}
                <div className="absolute top-0 left-0 w-[2px] h-8 bg-outline-variant"></div>
                <div className="absolute top-0 left-[50%] w-[2px] h-8 bg-outline-variant -ml-[1px]"></div>
                <div className="absolute top-0 right-0 w-[2px] h-8 bg-outline-variant"></div>
              </div>
            </div>
            ...
            <div className="flex justify-between w-[600px] relative -mt-8 pt-16">
              ...
              <div className="flex flex-col items-center relative">
                <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-4 w-56 shadow-sm z-10">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="material-symbols-outlined text-secondary" style={{ fontVariationSettings: "'FILL' 1" }} title="Custody Confirmed">verified_user</span>
                  </div>
                ...
                <div className="flex justify-between w-32 relative -mt-8 pt-16">
                  <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-3 w-28 shadow-sm z-10 text-center flex flex-col items-center">
              ...
              <div className="flex flex-col items-center relative">
                <div className="bg-error-container/10 border-2 border-error rounded-lg p-4 w-56 shadow-sm z-10">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="material-symbols-outlined text-error" title="Payment Overdue">warning</span>
                  </div>
              ...
              <div className="flex flex-col items-center relative">
                <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-4 w-56 shadow-sm z-10">
                  <div className="flex justify-between items-start mb-2">
                    <p className="font-label-caps text-label-caps text-on-surface-variant">Distributor</p>
                    <span className="material-symbols-outlined text-tertiary-container" style={{ fontVariationSettings: "'FILL' 1" }} title="Payment Verified">check_circle</span>
                  </div>
